<section class="promo">
    ...
    <ul class="promo__list">
        ...
        <li class="promo__item promo__item--<?=$value['alias']; ?>">
            <a class="promo__link" href="all-lots.php?category=<?=$value['category_id']; ?>"><?=$value['name']; ?></a>
        </li>
        <?php endforeach; ?>
    </ul>
</section>
    ...
    <ul class="lots__list">
        ...
        <li class="lots__item lot">
            ...
            <div class="lot__info">
                ...
                <h3 class="lot__title"><a class="text-link" href="lot.php/?id=<?=$value['lot_id']; ?>"><?=htmlspecialchars($value['title']);?></a></h3>
