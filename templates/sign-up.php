<form class="form container<?=empty($errors) ? '' : ' form--invalid'; ?>" action="sign-up.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__item<?=!isset($errors['password']) ? '' : ' form__item--invalid'; ?>">
        ...
        <input id="password" type="text" name="password" placeholder="Введите пароль" required<?=empty($information['password']) ? '' : ' value="' . $information['password'] . '"'; ?>>
        <span class="form__error"><?=!isset($errors['password']) ? '' : $errors['password']; ?></span>
    </div>
    <div class="form__item<?=!isset($errors['name']) ? '' : ' form__item--invalid'; ?>">
        <label for="name">Имя*</label>
        <input id="name" type="text" name="name" placeholder="Введите имя" required<?=empty($information['name']) ? '' : ' value="' . $information['name'] . '"'; ?>>
    ...
    <div class="form__item<?=!isset($errors['contacts']) ? '' : ' form__item--invalid'; ?>">
        ...
        <textarea id="contacts" name="contacts" placeholder="Напишите как с вами связаться" required><?=empty($information['contacts']) ? '' : $information['contacts']; ?></textarea>
